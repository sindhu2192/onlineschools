...
<head>
  ...
  <!-- Vendor CSS Files -->
    ...
    <asset:stylesheet src="vendor/aos/aos.css"/>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo me-auto"><asset:image src="img/logo.png" alt="" class="img-fluid"/></a>-->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <asset:image src="img/about.jpg" class="img-fluid" alt=""/>
          </div>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <asset:image src="img/course-1.jpg" class="img-fluid" alt="..."/>
              <div class="course-content">
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <asset:image src="img/trainers/trainer-1.jpg" class="img-fluid" alt=""/>
                    <span>Antonio</span>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              <asset:image src="img/course-2.jpg" class="img-fluid" alt="..."/>
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Marketing</h4>
                  <p class="price">$250</p>
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <asset:image src="img/trainers/trainer-2.jpg" class="img-fluid" alt=""/>
                    <span>Lana</span>
                  </div>
                  <div class="trainer-rank d-flex align-items-center">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              <asset:image src="img/course-3.jpg" class="img-fluid" alt="..."/>
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Content</h4>
                  <p class="price">$180</p>
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <asset:image src="img/trainers/trainer-3.jpg" class="img-fluid" alt=""/>
                    <span>Brandon</span>
                  </div>
                  <div class="trainer-rank d-flex align-items-center">
